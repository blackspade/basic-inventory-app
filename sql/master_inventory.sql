...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2019 at 05:01 PM
...
(7, 251148, '2 TON ADJUSTABLE SHOP CRANE LIFT', 0, 'ACTIVE', '{\"images\":[\"1574091034.JPG\"]}', '', 'SHOP CRANE', '$200.56', 'TITAN', '2T', '', 'TITAN ATTACHMENTS HELPS YOU LIFT HEAVY OBJECTS IN YOUR SHOP WITH THIS 2-TON SHOP CRANE. FOR THE BEST PERFORMANCE IN YOUR SHOP OR ON SITE, THIS IS JUST WHAT YOU NEED TO MAXIMIZE YOUR EFFICIENCY AND SAVE SPACE. THE POWERFUL HYDRAULIC RAM CAN LIFT THE H', 'ADMIN|1|Bryant Ricart', 'ADMIN|1|Bryant Ricart', '2019-11-18 10:30:34'),
(8, 961879, '11-GALLON HORIZONTAL PORTABLE AIR TANK', 0, 'ACTIVE', '{\"images\":[\"1574092014.JPG\"]}', '', ' AIR COMPRESSORS', '$59.57', 'PERFORMANCE TOOL', 'W10011', '', 'LIGHT WEIGHT, PORTABLE WITH HANDLE FOR EASY TRANSPORT\r\nSAFETY PRESSURE BYPASS VALVE WITH MANUAL OVERRIDE\r\nON/OFF AIR ADJUSTMENT DIAL\r\nINDUSTRIAL GRADE AIR HOSE WITH STANDARD TIRE AIR CHUCK ', 'ADMIN|1|Bryant Ricart', 'ADMIN|1|Bryant Ricart', '2019-11-18 10:46:54'),
(9, 650003, 'MISC ELECTRONICS', 0, 'ACTIVE', '{\"images\":[\"1574092631.JPG\"]}', '', 'MISCELLANEOUS', '$99.99', 'UNKNOWN', 'NONE', '', 'BULK ITEMS', 'ADMIN|1|Bryant Ricart', 'ADMIN|1|Bryant Ricart', '2019-11-18 10:57:11');
